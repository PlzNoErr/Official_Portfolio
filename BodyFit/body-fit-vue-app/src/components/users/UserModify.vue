      ...
      <div class="login-form">
        <div class="sign-in-htm">
          <div class="group">
            ...
            <input id="user" type="text" class="input" v-model="signupinfo.userId" style="cursor: not-allowed;" readonly />
          </div>
          <div class="group">
...
export default {
      ...
      $({
        ...
        .then((res) => {
          if (res.data.nickName) {
            if (res.data.nickName !== this.loginUser.nickName) {
              alert("중복된 닉네임 입니다! 새로운 닉네임을 입력해 주세요!");
              return;
            }
          }

          this.$store.dispatch("userModify", this.signupinfo);
        })
  ...
  created(){
    this.signupinfo.userId = this.loginUser.userId;
    this.signupinfo.nickName = this.loginUser.nickName;
    this.signupinfo.email = this.loginUser.email;
